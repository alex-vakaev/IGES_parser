...
- **Backend API service**: `src/`, `tests/`, `deploy/` at repository root
- **Container assets**: `Dockerfile`, optional `docker-compose.yml`
- Paths shown below assume a backend-only FastAPI project - adjust based on plan.md structure
...
- [ ] T004 [P] Create Docker build assets for local and deployment flows
...
- [ ] T015 [US1] Implement [Service] in src/services/[service].py with business-logic comments (depends on T013, T014)
...
- [ ] T022 [US2] Implement [Service] in src/services/[service].py with business-logic comments
...
- [ ] T028 [US3] Implement [Service] in src/services/[service].py with business-logic comments
...
- [ ] TXXX [P] Deployment guide updates in docs/ or README
- [ ] TXXX Code cleanup and refactoring
- [ ] TXXX Performance optimization across all stories
- [ ] TXXX [P] Additional unit tests in tests/unit/
- [ ] TXXX Security hardening
- [ ] TXXX Run quickstart.md validation
- [ ] TXXX Validate Docker build and container startup flow
...
- Required API tests MUST be written and FAIL before implementation
- Models before services
- Services before endpoints
- Core implementation before integration
- Add comments where business logic or non-obvious flow is introduced
